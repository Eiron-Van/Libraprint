...
echo "<h1 class='pb-6 text-4xl text-white font-semibold text-center'>Users</h1> 
        <div class='overflow-auto rounded-lg shadow-lg shadow-gray-500/30 max-h-[61.8vh]'>
            <!-- Header -->
            <div class='grid grid-cols-11 p-2 bg-gray-700 sticky top-0'>
...
if ($usersResult->num_rows > 0){
    while ($row = $usersResult->fetch_assoc()){
        echo "<div class='grid grid-cols-11 p-2 bg-gray-200 text-xs text-black border-b border-black whitespace-normal break-all'>
                ...
                <div class='flex justify-center items-center min-w-0 p-1 col-span-1'>" . highlightTerms($row['first_name'] . " " . $row['last_name'], $search) . "</div>
