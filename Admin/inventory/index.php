...
<body class="bg-gradient-to-b from-[#304475] to-[#0c0c0c] bg-fixed min-h-screen">
        ...
        <div id ="side-menu" class="hidden flex-col bg-[#F4F4F4] w-fit top-19 fixed z-[9] inset-y-0">
            <nav class="flex flex-col bg-[#F4F4F4] h-[calc(100vh-84px)] justify-between">
                <ul>
                    ...
                    <li><a class=" text-black text-2xl hover:bg-slate-200 active:bg-slate-300 w-full px-5 py-4 flex items-center" href="https://libraprintlucena.com/Registration/"><img class="w-8 m-2" src="../asset/reports.png">Registration</a></li>                    
    ...
    <main class=" flex flex-col px-15">
        ...
        <div id="results" class="overflow-auto max-h-[70vh] rounded-lg shadow text-white">
            Loading...
        </div>
    </main>
</body>
