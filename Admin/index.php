...
<body class="bg-gradient-to-b from-[#304475] to-[#0c0c0c] bg-fixed">
    ...
    <header class="bg-gray-900 text-white sticky top-0 z-10">
        <section class="max-w-[100rem] mx-auto p-3 lg:p-2 flex justify-between items-center">
            <div class="flex items-center mx-4 space-x-6">
                <button id="menu" title="Open navigation menu"
                    class="text-[30px] focus:outline-none cursor-pointer hover:opacity-60 active:opacity-40 transition-opacity duration-200 p-2">
            ...
            <div>
                <a href="/Admin/report.php"
                    class="flex items-center justify-center bg-[#005f78] hover:bg-[#064358] shadow-lg shadow-[#005f78]/50 transition-opacity duration-200 px-2 py-1 rounded">Generate
                    report</a>
            </div>
        </section>
    </header>
    ...
    <!-- 📘 Return Book Overlay -->
    <div id="returnOverlay" class="fixed hidden inset-0 bg-gray-900/90 items-center justify-center z-50">
        <div class="bg-white rounded-xl p-6 w-96 shadow-lg text-center relative">
            <h2 class="text-3xl font-bold mb-4">Return Book</h2>
            <input type="text" id="returnBarcode" placeholder="Scan or type barcode..."
                class="border rounded-md p-2 w-full mb-4 text-center focus:outline-none">
        ...
        <div class="flex flex-col justify-evenly h-39.5 p-4 text-white select-none">
            <div>
                <input type="radio" name="condition" value="Good Condition" id="good-condition" checked>
                <label for="good-condition">Good Condition</label>
            </div>
            <div>
                <input type="radio" name="condition" value="Worn Out Condition" id="bad-condition">
                <label for="bad-condition">Worn Out Condition</label>
            </div>
        </div>
    </div>
